...
var rootUrl = 'http://192.168.0.103:3000/';
var LocalDDPConnection = DDP.connect(rootUrl);

// The collection of acceptable client versions.
ClientVersions = new Mongo.Collection("meteor_autoupdate_clientVersions", { connection: LocalDDPConnection });
...
var onNewVersion = function () {
  ...
  var urlPrefix = rootUrl + '__cordova';
...
Autoupdate._retrySubscription = function () {
  ...
  LocalDDPConnection.subscribe("meteor_autoupdate_clientVersions", appId, {
